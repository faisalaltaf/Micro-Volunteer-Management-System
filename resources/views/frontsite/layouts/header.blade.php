                        ...
                        <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left d-flex">
                                    <ul>     
                                        <li>Phone: +9203069309614</li>
                                        <li>Email: BC180408585@vu.edu.com</li>
                                    </ul>
                                    ...
                                    <div class="select-this">
                                        <form action="#">
                                            <div class="select-itms">
                                                ...
                                                </select><div class="nice-select" tabindex="0"><span class="current">English</span><ul class="list"><li data-value="" class="option selected">English</li><li data-value="" class="option">Bangla</li><li data-value="" class="option">Arabic</li><li data-value="" class="option">Hindi</li></ul></div>
                                            </div>
                                        </form>
                                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="index.html"><img src="{{asset('charityfrontassets/assets/img/logo/logo.png')}}" alt=""></a>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="mobile_menu d-block d-lg-none"><div class="slicknav_menu"><a href="#" aria-haspopup="true" role="button" tabindex="0" class="slicknav_btn slicknav_collapsed" style="outline: none;"><span class="slicknav_menutxt">MENU</span><span class="slicknav_icon"><span class="slicknav_icon-bar"></span><span class="slicknav_icon-bar"></span><span class="slicknav_icon-bar"></span></span></a><ul class="slicknav_nav slicknav_hidden" aria-hidden="true" role="menu" style="display: none;">                                                                                          
                                                <li><a href="{{route('index')}}" role="menuitem" tabindex="-1">Home</a></li>
                                                <li><a href="{{route('about')}}" role="menuitem" tabindex="-1">About</a></li>
